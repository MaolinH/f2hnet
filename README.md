...
## Classification on ImageNet-1K  
 ...
 In the "Infer" column, 1784(3298) represents different testing methods that they respectively reference early methods (e.g., Swin) and modern approaches (e.g., MambaVision).
